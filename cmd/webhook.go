...
`,
	...
	webhookCmd.Flags().StringVar(&webhookCfg.GARSecret, "gar-webhook-secret", env.GetStringVal("GAR_WEBHOOK_SECRET", ""), "Secret for validating Google Artifact Registry webhooks")
